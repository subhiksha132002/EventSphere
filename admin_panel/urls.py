...
urlpatterns = [
    ...
    path('users/<int:user_id>/delete_user/', views.delete_user, name='delete_user'),
    ...
    path('event_organizers/<int:organizer_id>/delete_organizer/', views.delete_organizer, name='delete_organizer')
]
